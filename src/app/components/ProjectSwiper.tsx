...
export function ProjectSwiper({ 
  ...
  return (
    <div className="relative h-[100px] md:h-[100px] lg:h-[100px] rounded-2xl overflow-hidden shadow-lg hover:shadow-accent-red">   {/* ← Altezza fissa controllata */}
...
export function ProjectSwiper1({ 
  ...
  return (
    <div className="relative h-[320px] md:h-[900px] lg:h-[450px] rounded-2xl overflow-hidden shadow-lg">   {/* ← Altezza fissa controllata */}
      ...
      {/* Frecce */}
      <button 
        className={`${id}-prev absolute left-4 top-1/2 -translate-y-1/2 z-50 
                   bg-white/90 hover:bg-white text-gray-900 p-3 rounded-full shadow-xl transition-all hover:scale-110`}
      >
        <ChevronLeft className="size-7" />
      </button>
      ...
      <button 
        className={`${id}-next absolute right-4 top-1/2 -translate-y-1/2 z-50 
                   bg-white/90 hover:bg-white text-gray-900 p-3 rounded-full shadow-xl transition-all hover:scale-110`}
      >
        <ChevronRight className="size-7" />
      </button>
