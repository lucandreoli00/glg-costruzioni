      ...
      <section className="py-16 bg-boero/15 text-stone-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl text-accent-red font-bold mb-2">20+</div>
              <div className="text-stone-700">Anni di Esperienza</div>
            </div>
            <div>
              <div className="text-4xl text-accent-red font-bold mb-2">500+</div>
              <div className="text-stone-700">Progetti Completati</div>
            </div>
            <div>
              <div className="text-4xl text-accent-red font-bold mb-2">100%</div>
              <div className="text-stone-700">Clienti Soddisfatti</div>
            </div>
            <div>
              <div className="text-4xl text-accent-red font-bold mb-2">30+</div>
              <div className="text-stone-700">Professionisti</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-boero/15 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
            ...
            <div className="bg-boero/15 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="font-semibold text-xl mb-2">Manutenzioni</h3>
                <p className="text-gray-600 mb-4">
