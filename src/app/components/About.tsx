...
<section className="font-logo py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-logo text-4xl font-semibold mb-4">I Nostri Progetti</h2>
            <p className="text-gray-600">Clicca sulle frecce o passa il mouse per vedere tutte le foto</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-1  lg:grid-cols-2 grid-rows-3 gap-8">
      ...
      */}
      ...
      <section className="font-logo py-16 bg-boero/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold mb-4">I Nostri Valori</h2>
